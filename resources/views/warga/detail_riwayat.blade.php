    ...
    <div class="row">
                                ...
                                <td>
                                    @if ($data->status_berkas == 'Pengajuan')
                                        @if ($berkas->m_syarat->format == 'Gambar')
                                            <div class="my-2"></div>
                                            <div>
                                                <a href="/riwayat-pengajuan/{{ $berkas->isi_berkas }}/view"
                                            ...
                                            <div class="my-2"></div>
                                            <div>
                                                <a href="/riwayat-pengajuan/{{ $berkas->isi_berkas }}/download"
                                                    class="btn btn-primary btn-icon-split">
                                                    <span class="icon text-white-50">
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <table class="table table-bordered table table-tracking table-responsive">
                        <thead>
                            <tr>
        ...
        @if ($data->status_berkas == 'Pengajuan')
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <div class="card-body">
                            <a href="/riwayat-pengajuan" class="btn btn-warning btn-icon-split">
                                <span class="icon text-white-50">
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow">
                <div class="card-body">
                        ...
                        <a href="/riwayat-pengajuan/{{ $data->hasil_file }}/{{ $data->tiket }}/download-hasil"
