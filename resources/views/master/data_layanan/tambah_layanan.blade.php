...
@section('isi')
    <h1 class="h3 mb-4 text-gray-800">Tambah Data Layanan</h1>
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/simpan-layanan">
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="status_layanan" name="status_layanan">
                                    ...
                                    <option value="YA" {{ old('status_layanan') == 'YA' ? 'selected' : '' }}>Ya
                                    </option>
                                    <option value="Tidak" {{ old('status_layanan') == 'Tidak' ? 'selected' : '' }}>Tidak
                                    </option>
                                </select>
