    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    {{-- <div class="my-2"></div> --}}
                    <a href="tambah-layanan" class="btn btn-primary float-end btn-icon-split">
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $data)
                                <tr>
                                    ...
                                    <td align="center">{{ $data->status_layanan }}</td>
                                    <td>
                                        <a href="/data-layanan/{{ $data->id }}/edit"
    ...
    <script>
        $('.hapus').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/data-layanan/" + layanan_id + "/delete";
                    }
                });
        });
    </script>
