        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/simpan-penduduk">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <select class="form-control" id="status_nikah" name="status_nikah">
                                    ...
                                    <option value="Belum Kawin"
                                        {{ old('status_nikah') == 'Belum Kawin' ? 'selected' : '' }}>Belum Kawin</option>
                                    <option value="Kawin" {{ old('status_nikah') == 'Kawin' ? 'selected' : '' }}>Kawin
                                    </option>
                                    <option value="Duda" {{ old('status_nikah') == 'Duda' ? 'selected' : '' }}>Duda
                                    </option>
                                    <option value="Janda" {{ old('status_nikah') == 'Janda' ? 'selected' : '' }}>Janda
                                    </option>
                                </select>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input type="number" class="form-control" id="rt" name="rt" value="{{ old('rt') }}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="rw">RW</label>
                                <input type="number" class="form-control" id="rw" name="rw" value="{{ old('rw') }}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="kode_pos">Kode Pos</label>
                                <input type="number" class="form-control" id="kode_pos" name="kode_pos" value="{{ old('kode_pos') }}">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="email">E-Mail</label>
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="ex. xxx@gmail" value="{{ old('email') }}">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control" id="pekerjaan" name="pekerjaan">
                                    ...
                                    <option value="Tenaga Pengajar/Instruktur/Fasilitator" {{ old('pekerjaan') == 'Tenaga Pengajar/Instruktur/Fasilitator' ? 'selected' : '' }}>Tenaga
                                        Pengajar/Instruktur/Fasilitator</option>
                                    <option value="Petani" {{ old('pekerjaan') == 'Petani' ? 'selected' : '' }}>Petani</option>
                                    <option value="Pedagang Kecil" {{ old('pekerjaan') == 'Pedagang Kecil' ? 'selected' : '' }}>Pedagang Kecil</option>
                                    ...
                                    <option value="Pedagang Besar" {{ old('pekerjaan') == 'Pedagang Besar' ? 'selected' : '' }}>Pedagang Besar</option>
